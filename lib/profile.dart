...
class _ProfileState extends State<Profile> with SingleTickerProviderStateMixin {
  ...
  Future<List> postCardBuilder(docs) async {
    ...
    for (var doc in docs) {
      ...
      await docRef.get().then((DocumentSnapshot data) async {
    ...
    for (var item in pics) {
      DocumentReference docRef =
          await db.collection("UserAccount").doc(item["Poster"]);
      await docRef.get().then((DocumentSnapshot data) {
                ...
                pc = Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(
                            width: 20), // Adding space for better alignment
                        CircleAvatar(
                          radius: 40,
                        ...
                        SizedBox(
                            width: 20), // Adding space between bio and counts
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
                    ...
                    SizedBox(
                        width:
                            20), // Adding space between profile picture and name
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                        ...
                        ElevatedButton(
                            onPressed: () async {
                              Uri url =
                                  Uri.parse(website); // personal website url
                              await launchUrl(url);
                            },
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      ...
                                      builder: (context) => PostCardScreen(
                                          ...
                                          userImage: pics[index]
                                              ["ProfilePicture"],
                                          description: pics[index]
                                              ["Description"],
                            ...
                            child: Column(
                              ...
                              children: [
                                            ...
                                            return Column(
                                              ...
                                              children: [
                                                ListTile(
                                                  ...
                                                  subtitle: Text(
                                                    resource
                                                        .description, // Assuming description exists in your Resource class
                                                  ),
                                ...
                                ElevatedButton(
                                  ...
                                  child: Text(
                                      'My Resources'), // Button labeled "My Resources"
                                ),
                              ],
                            ),
                          ),
                          FutureBuilder(
                              ...
                              builder: ((BuildContext context,
                                ...
                                if (snapshot.connectionState ==
                                  ...
                                  return Center(
                                      child: Text("Bookmarks Snapshot Error"));
                                } else {
                                  return const Center(
                                      child: Expanded(
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => LessonBookingPage(
                          name: resource["Name"],
                          resourceID: doc.id,
                          numPlayers: resource["PeopleAmount"],
                          bookDate: resource["Date"],
                          duration: resource["HoursAmount"],
                          priceHour: resource["PriceHour"],
                          pricePerson: resource["PricePerson"],
                        )));
          },
        );
        resources.add(rc);

...
class CaptionAndShareScreen extends StatefulWidget {
  ...
  const CaptionAndShareScreen({Key? key, required this.imageFile})
      : super(key: key);
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (result != null) {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      CaptionAndShareScreen(imageFile: file)),
                            );
                          } else {
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: Colors.red[
                              600], // Text color for the ElevatedButton style
